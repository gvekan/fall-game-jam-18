...
IMG_ROAD = [[pygame.image.load("src/medieval_road.png").convert_alpha()], [pygame.image.load("src/present_road.bmp").convert_alpha()], [pygame.image.load("src/future_road.bmp").convert_alpha()]]
DEBUG = True

IMG_MEDIEVAL_PLAYER = [pygame.image.load("src/tr1.png"), pygame.image.load("src/tr2.png").convert_alpha(), pygame.image.load("src/tr1.png").convert_alpha(), pygame.image.load("src/tr3.png").convert_alpha()]
...
IMG_CASTLE = [[pygame.image.load("src/castle1.png").convert_alpha()],[pygame.image.load("src/castle2.png").convert_alpha()],[pygame.image.load("src/castle3.png").convert_alpha()]]
