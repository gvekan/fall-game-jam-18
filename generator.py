...
class Generator:
    ...
    def add_road(self, state: State):
        r = AnimationSprite(IMG_MEDIEVAL_ROAD, (WINDOW_SIZE[0]+self.road_next_x+state.scroll_length, LANE_START_Y), SCENERY_HITBOX)
    ...
    def add_obstacle(self, state: State):
        obj = AnimationSprite(IMG_MEDIEVAL_PLAYER,
